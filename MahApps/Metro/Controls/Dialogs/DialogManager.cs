...
namespace MahApps.Metro.Controls.Dialogs
{
    public static class DialogManager
    {
        ...
        /// <param name="title">The title of the LoginDialog.</param>
        /// <param name="message">The message contained within the LoginDialog.</param>
        /// <param name="empresas">Te content of the combobox.</param>
        /// <param name="settings">Optional settings that override the global metro dialog settings.</param>
        /// <returns>The text that was entered or null (Nothing in Visual Basic) if the user cancelled the operation.</returns>
        public static Task<SALoginDialogData> ShowLoginAsync(this MetroWindow window, string title, string message, List<object> empresas, LoginDialogSettings settings = null)
        {
            window.Dispatcher.VerifyAccess();
            return HandleOverlayOnShow(settings, window).ContinueWith(z =>
            {
                return (Task<SALoginDialogData>)window.Dispatcher.Invoke(new Func<Task<SALoginDialogData>>(() =>
                {
                    if (settings == null)
                    {
                        settings = new LoginDialogSettings();
                    ...
                    //create the dialog control
                    SALoginDialog dialog = new SALoginDialog(window, settings)
                    {
                        Title = title,
                        Message = message,
                        Empresas=empresas
        ...
        public static Task HandleOverlayOnHide(MetroDialogSettings settings, MetroWindow window)
        {
        ...
        public static Task HandleOverlayOnShow(MetroDialogSettings settings, MetroWindow window)
        {
        ...
        public static Window SetupExternalDialogWindow(BaseMetroDialog dialog)
        {
